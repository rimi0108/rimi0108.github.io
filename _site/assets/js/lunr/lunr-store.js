var store = [{
        ...
        "excerpt":"Django Management Command는 python manage.py shell, python manage.py migrate 와 같이 우리가 장고를 사용할 때 자주 사용하는 명령어를 말한다. 우리는 이 Django Command를 Custom하여 원하는 동작을 원하는 명령어로 커스텀하여 만들어 줄 수 있다. custom command 만들기 원하는 app 폴더 밑에 management 폴더를 만들고 그 밑에 commands 폴더를 만든다. 앱이름/management/commands 이런...","categories": ["Django"],
        "tags": ["TIL","Python"],
        "url": "/django/custom-command/",
        "teaser": null
      },{
        "title": "[Docker] Django + MySQL 환경 구성하기",
        "excerpt":"docker 설치완료를 가정하고 진행해보겠습니다. mac os 환경에서 진행되었습니다. Django 프로젝트를 만들어주고 프로젝트 폴더안에 Dockerfile과 docker-compose.yml 파일을 생성해줍니다. 참고로, Docker-Compose로 도커 컨테이너를 자동 생성한 후, DockerFile로 생성한 컨테이너 안에 자동으로 세팅 작업까지 돌아갈 수 있도록 할 수 있습니다. Django 프로젝트 폴더 구조 . ├── Dockerfile ├── README.md ├── __pycache__ │   └──...","categories": ["Docker"],
        "tags": ["TIL","Django","MySQL","Docker"],
        "url": "/docker/docker/",
        "teaser": null
      }]
